                                    ...
                                    @if($reg->participant?->team?->whatsapp_group_link)
                                        <a href="{{ $reg->participant->team->whatsapp_group_link }}"
                                           ...
                                           onmouseover="this.style.opacity='0.88'" onmouseout="this.style.opacity='1'">
                                            ...
                                            Gabung Grup WhatsApp Kelompok
                                        </a>
                                        <span style="font-size:0.7rem; color:#b8a070; font-style:italic;">Khusus orang tua &mdash; klik untuk bergabung ke grup WhatsApp kelompok anak Anda</span>
                                    @else
