...
class EventPeriodSeeder extends Seeder
{
    public function run(): void
    {
        $periods = [
            ...
            ['year' => 2024, 'theme' => '-'],
            ['year' => 2025, 'theme' => 'Messenger of Joy & Love','start' => '2025-06-24', 'end' => '2025-06-26' , 'event_logo' => 'event-logos/LOGO-SKS-2026.png'],
            ['year' => 2026, 'theme' => 'Yeeess Lord!','start' => '2026-06-24', 'end' => '2026-06-26', 'event_logo' => 'event-logos/LOGO-SKS-2025.png'],
        ];
